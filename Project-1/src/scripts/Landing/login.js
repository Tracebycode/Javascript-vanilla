...
export function  loginform(params) {
    ...
    loginBtn.addEventListener('click',()=>{
        ...
        if(loginform){
            ...
            //     const Passward = loginform['userpassward'].value;
            // })
            ...
            if(googlelogin){
                ...
                console.log("google login button clicked");
                  const success = await handleloginwithgoogle();
                  if(success){
...
function createaccountform(){
    ...
    <div>  
      <button id="googlelogin" type="button" class="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
